  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With SCHEDULE, effortlessly manage your room bookings. Choose a room, pick a date, view scheduled activities, and make your reservations with just a few clicks. Streamline your room booking process today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With SCHEDULE, effortlessly manage your room bookings. Choose a room, pick a date, view scheduled activities, and make your reservations with just a few clicks. Streamline your room booking process today.`}
            </Text>
            <Box
